...
predictor = dlib.shape_predictor("D:\SEM 5\ESD\Driver-drowsiness-detection--master\shape_predictor_68_face_landmarks.dat")
    		...
    		# drawing contours over the eyes
				...
				# alarm becomes on if it is off
					...
					# checking if the alarm file is supplied and if so then play the alarm
                                    if ala!= "":
                                            winsound.PlaySound(ala, winsound.SND_ASYNC)
